...
var ListContainer = function (_React$Component) {
  ...
  _createClass(ListContainer, [{
    ...
    value: function render() {
      var listitems = this.props.arr.map(function (item, index) {
...
var _listcontainer = __webpack_require__(24);
...
var TaskContainer = function (_Component) {
  ...
  function TaskContainer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TaskContainer.__proto__ || Object.getPrototypeOf(TaskContainer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      pending: true,
      current_directory: [],
      data: []
  ...
  _createClass(TaskContainer, [{
    key: 'onEnterSendCommand',
    value: function onEnterSendCommand(e) {
      if (e.keyCode == "13") {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('p', { className: 'border', id: 'a', contentEditable: 'true', onKeyUp: function onKeyUp(e) {
            return _this3.onEnterSendCommand(e);
          } }),
        _react2.default.createElement(
          'p',
          null,
...
_reactDom2.default.render(_react2.default.createElement(TaskContainer, { idn: 'b' }), document.getElementById('container'));
_reactDom2.default.render(_react2.default.createElement(_listcontainer2.default, { arr: dataArray }), document.getElementById('container2'));
